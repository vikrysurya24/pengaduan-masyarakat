    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <div class="form-group cols-sm-6">
                <a href="?url=verifikasi_tanggapan" class="btn btn-primary btn-icon-split">
                ...
                ?>
                <a href="proses.php?id=<?= $data['id_pengaduan']; ?>" class="btn btn-danger btn-icon-split" onclick="return confirm('Yakin akan diproses?');">
                    <span class="icon text-white-50">
