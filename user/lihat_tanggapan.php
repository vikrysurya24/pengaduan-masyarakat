    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <div class="form-group cols-sm-6">
                <a href="?url=lihat_laporan" class="btn btn-primary">
            ...
            ?>
                    <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group cols-sm-6">
                            ...
                            <input type="text" name="tgl_tanggapan" id="tgl_tanggapan" value="<?= $data['tgl_tanggapan']; ?>" class="form-control" readonly>
                        </div>
                        <div class="form-group cols-sm-6">
                        ...
                        <div class="form-group cols-sm-6">
                            ...
                            <input type="text" name="tanggapan" id="tanggapan" value="<?= $data['tanggapan']; ?>" class="form-control" readonly>
                        </div>
                    </form>
            <?php }
            } ?>
